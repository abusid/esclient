...
public class ESClientManager {
    ...
    public  ElasticsearchClient makeESClient() throws IOException {
        ...
        int numberOfNodes = getNumberofNodes(transport);
        System.out.println("number of nodes running "+ numberOfNodes);
